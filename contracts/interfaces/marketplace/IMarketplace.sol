...
interface IMarketplace is IThirdwebContract, IPlatformFee {
    ...
    **/
    struct ListingParameters {
        ...
        uint256 quantityToList; // 资产数量
        address currencyToAccept; // 接受的货币地址
        uint256 reservePricePerToken; // 最低保留价格
        uint256 buyoutPricePerToken; //一口价
        ListingType listingType; // 资产类型
    }
